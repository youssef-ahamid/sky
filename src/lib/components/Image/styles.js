export const imgWrapper = props => {
  return [
    ...
    { classes: 'inline-block', styles: '', on: props.type == 'square' },
...
export const imgOverlay = props => {
  return [
    ...
    { classes: 'absolute inset-0 -translate-y-6 group-hover:-translate-y-12 translate-x-6 group-hover:translate-x-12 bg-neutral-light hexagon z-[1]', styles: '', on: props.type == 'square' },
  ]
}
...
export const img = props => {
  return [
    ...
    { classes: 'rounded-2xl md:rounded-[60px] group-hover:scale-110', styles: '', on: props.type == 'feature' },
    { classes: 'relative z-[2] w-80 h-80 object-cover hexagon group-hover:scale-110', styles: '', on: props.type == 'square' },
