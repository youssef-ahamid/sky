...
export let list = 'w-full lg:max-w-[70%] px-8 pt-5 grid grid-cols-2 lg:grid-cols-3 items-start my-6'
export let links = 'w-full flex flex-col md:flex-row items-start justify-between px-6'
...
export let link = 'px-2 one-liner md:px-4 py-2 md:py-4 text-current hover:text-primary'
export let logo = 'block w-32 overflow-visible py-4 md:w-36 group text-primary hover:scale-105 origin-center'
